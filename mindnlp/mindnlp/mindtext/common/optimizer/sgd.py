...
class SGD(Optimizer):
    ...
    def __init__(self, params: Union[List[Parameter], List[dict]],
                 learning_rate: Union[float, Tensor, Iterable] = 0.1, momentum: float = 0.0, dampening: float = 0.0,
                 weight_decay: float = 0.0, nesterov: bool = False, loss_scale: float = 1.0) -> Optimizer:
