...
# ============================================================================
"""Roberta for Sequence Classification script."""
...
class RobertaFinetuneCell(nn.Cell):
    """
    ...
    def __init__(self, network, optimizer, scale_update_cell=None):
        ...
        super(RobertaFinetuneCell, self).__init__(auto_prefix=False)
...
class RobertaforSequenceClassification(nn.Cell):
    """
    Train interface for classification finetuning task.
    """

    def __init__(self, config, is_training=False, num_labels=2, dropout_prob=0.1, multi_sample_dropout=1, label_smooth=1):
        super(RobertaforSequenceClassification, self).__init__()
        if not is_training:
            config.hidden_dropout_prob = 0.0
            config.hidden_probs_dropout_prob = 0.0

        self.roberta = RobertaEmbedding(config, is_training)
        self.cast = P.Cast()
    ...
    def init_embedding(self, embedding):
        ...
        self.roberta = embedding

    def construct(self, input_ids, input_mask, label_ids=None):
        """
        Classification task
        """
        _, pooled_output = self.roberta(input_ids, input_mask)
        loss = None
        if self.is_training:
