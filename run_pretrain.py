...
from src.adam import AdamWeightDecayForBert
from src.optimizer import BertAdam

from tqdm import tqdm

def train(model, optimizer, train_dataset, epochs, jit=True):
    """
...
if __name__ == '__main__':
    ...
    # mindspore.set_context(save_graphs=True, save_graphs_path='./graphs')
    ...
    # optimizer = BertAdam(model.trainable_params(), lr=0.1, t_total=total)
